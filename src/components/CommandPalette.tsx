...
import { LayoutDashboard, Handshake, Users, MessageSquare, PlusCircle, Building, Contact, Briefcase, BookOpen, Target, ListFilter, LayoutGrid, FileText, CheckSquare, TrendingUp, BarChart3 } from 'lucide-react';
    ...
    <CommandDialog open={open} onOpenChange={setOpen}>
      ...
      <CommandList>
        ...
        <CommandGroup heading="Navigation">
          ...
          <CommandItem onSelect={() => runCommand(() => navigate('/reporting'))}>
